<template>
  <transition name="viewer-fade">
    <div tabindex="-1" ref="el-image-viewer__wrapper" class="el-image-viewer__wrapper" :style="{ 'z-index': zIndex,'width':w+'px','height':h+'px' }">
      ...
      <!-- CANVAS -->
      <div class="el-image-viewer__canvas" v-drag>
        <img
